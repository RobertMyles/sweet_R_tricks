...
So far, so good -- the data is in our browser. In theory, now we can include a `js` code block. It's worth mentioning that, for me at least, this doesn't work perfectly (I'm probably doing something wrong). I had to actually include this code in the html of this README (you can see that it is doubled in the inspector of your browser or by looking at the page source).
